...
export declare function ExpressAuth(config: ExpressAuthConfig): (req: e.Request, res: e.Response, next: e.NextFunction) => Promise<void>;
export type GetSessionResult = Promise<Session | null>;
export declare function getSession(req: e.Request, config: ExpressAuthConfig): GetSessionResult;
